...
class WhizzyAdvanced {
	...
	public function enqueue_frontend_scripts() {
		...
		wp_enqueue_script( 'whizzy-advanced-main', WHIZZY_PLUGIN_URL . '/assets/js/advanced.js', array( 'whizzy-plugin-script' ), null, true );
		wp_enqueue_script( 'whizzy-advanced-shortcodes', WHIZZY_PLUGIN_URL . '/assets/js/shortcodes.js', array( 'lightgallery' ), null, true );
	}
	...
	public function enqueue_admin_scripts() {
        ...
        wp_enqueue_script( 'whizzy-advanced-admin', WHIZZY_PLUGIN_URL . '/assets/js/admin-advanced.js', array( 'jquery' ), null, true );
    }
    ...
    public function enqueue_shortcode_scripts() {
        wp_enqueue_script( 'whizzy-admin-shortcodes', WHIZZY_PLUGIN_URL . '/assets/js/admin-shortcodes.js', array( 'jquery' ), null, true );
    }
    ...
    public function whizzy_gallery_buttons() {
        ...
        if ( $client && ! $approve_status ) {
	        ...
	        if ( $galley_client == get_current_user_id() ) {
	            echo '<button class="button-download a-btn-2 button whizzy-pro-approve-gallery" data-id="'. $gallery_id .'" data-nonce="'. wp_create_nonce( 'WhizzyAdvanced' ) .'">';
            ...
            <div id="whizzy-photo-comments-modal" class="white-popup">
                ...
                <div class="popup-scroll">
                    ...
                    <form id="whizzy-photo-comments-form" method="post">
                        ...
                        <button type="submit" class="btn btn-primary"><?php _e( 'Send', 'whizzy' ); ?></button>
                    </form>
